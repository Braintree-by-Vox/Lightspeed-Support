...
The debtors book can be brought on as opening balances per customer, or open entries (transactions with an outstanding balance).

From the Opening Balances Configuration page, click on '▶️Run Setup' for the task 'Take on Debtors open items':
...
[**⬆️ Back to Top**](#debtors-open-items-take-on) &nbsp;&nbsp;&nbsp;&nbsp; [**🏠 Home**](/Lightspeed-Support)